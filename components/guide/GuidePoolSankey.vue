...
<template>
  ...
  >
    ...
    <desc :id="descId">
      Sankey showing the 12,000-case eval pool splitting into train, validation and test, and how
      one optimizer run scores only a 200-case validation snapshot and a 400-case test snapshot
      while the rest is curated or held in reserve.
    </desc>
    ...
    <text
      ...
      letter-spacing="0.14em"
    >
      USED IN ONE OPTIMIZER RUN
    </text>

    <!-- Ordinary ribbons (k = 0.04 px per case) -->
    <path
      class="gd-ribbon"
      d="M172,148 C333,148 333,108 494,108 L494,396 C333,396 333,436 172,436 Z"
    />
    <path
      class="gd-ribbon"
      d="M172,436 C333,436 333,436 494,436 L494,532 C333,532 333,532 172,532 Z"
    />
    <path
      class="gd-ribbon"
      d="M172,532 C333,532 333,572 494,572 L494,668 C333,668 333,628 172,628 Z"
    />
    <path
      class="gd-ribbon"
      d="M506,108 C653,108 653,88 800,88 L800,376 C653,376 653,396 506,396 Z"
    />
    <path
      class="gd-ribbon"
      d="M506,444 C653,444 653,464 800,464 L800,552 C653,552 653,532 506,532 Z"
    />
    <path
      class="gd-ribbon"
      d="M506,572 C653,572 653,552 800,552 L800,632 C653,632 653,652 506,652 Z"
    />

    <!-- Focal path: the cases the optimizer actually scores -->
    <path
      class="gd-ribbon gd-ribbon--focal"
      d="M506,436 C653,436 653,416 800,416 L800,424 C653,424 653,444 506,444 Z"
    />
    <path
      class="gd-ribbon gd-ribbon--focal"
      d="M506,652 C653,652 653,672 800,672 L800,688 C653,688 653,668 506,668 Z"
    />
    ...
    <!-- Column 1 labels -->
    <text class="gd-title" x="148" y="384" font-size="12" font-weight="600" text-anchor="end">
      Eval pool
    </text>
    ...
    <text class="gd-title" x="500" y="88" font-size="12" font-weight="600" text-anchor="middle">
      Train
    </text>
    <text class="gd-meta" x="500" y="100" font-size="9" text-anchor="middle">7,200 · 60%</text>
    <text class="gd-title" x="500" y="412" font-size="12" font-weight="600" text-anchor="middle">
      Validation
    </text>
    <text class="gd-meta" x="500" y="424" font-size="9" text-anchor="middle">2,400 · 20%</text>
    <text class="gd-title" x="500" y="548" font-size="12" font-weight="600" text-anchor="middle">
      Test
    </text>
    <text class="gd-meta" x="500" y="560" font-size="9" text-anchor="middle">2,400 · 20%</text>

    <!-- Column 3 labels -->
    <text class="gd-title" x="816" y="228" font-size="12" font-weight="600">
      Relabel &amp; review only
    </text>
    ...
    <text class="gd-title" x="816" y="544" font-size="12" font-weight="600">
      Not drawn this run
    </text>
    ...
    <text class="gd-legend" x="284" y="744" font-size="9">
      Scored by the optimizer: 600 of 12,000
    </text>
    <text class="gd-callout" x="620" y="746" font-size="14">
      Only 5% of the pool is ever scored in a run.
    </text>
  </svg>
</template>
