...
<template>
  ...
  >
    ...
    <!-- m1 POST run -->
    <line class="gd-edge gd-edge--http" x1="104" y1="128" x2="296" y2="128" :marker-end="`url(#${arrowHttpId})`" />
    <text class="gd-label gd-label--http gd-label--knockout" x="200" y="117" font-size="8" text-anchor="middle" letter-spacing="0.06em">POST /OPTIMIZER/RUN</text>
    <!-- m2 202 -->
    <line class="gd-edge" x1="296" y1="156" x2="104" y2="156" stroke-dasharray="5,4" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="200" y="145" font-size="8" text-anchor="middle" letter-spacing="0.06em">202 · RUN_ID</text>

    <!-- m3 baseline eval -->
    <line class="gd-edge" x1="304" y1="196" x2="696" y2="196" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="600" y="185" font-size="8" text-anchor="middle" letter-spacing="0.06em">EVAL BASELINE · 200</text>
    <!-- m4 baseline return -->
    <line class="gd-edge" x1="696" y1="236" x2="304" y2="236" stroke-dasharray="5,4" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="400" y="225" font-size="8" text-anchor="middle" letter-spacing="0.06em">BASELINE ACC + FAILURES</text>

    <!-- m5 analyze + generate -->
    <line class="gd-edge" x1="304" y1="328" x2="496" y2="328" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="400" y="317" font-size="8" text-anchor="middle" letter-spacing="0.06em">ANALYZE + GENERATE</text>
    <!-- m6 candidate return -->
    <line class="gd-edge" x1="496" y1="356" x2="304" y2="356" stroke-dasharray="5,4" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="400" y="345" font-size="8" text-anchor="middle" letter-spacing="0.06em">ANALYSIS + CANDIDATE</text>

    <!-- m7 eval candidate -->
    <line class="gd-edge" x1="304" y1="396" x2="696" y2="396" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="600" y="385" font-size="8" text-anchor="middle" letter-spacing="0.06em">EVAL CANDIDATE · 200</text>
    <!-- m8 candidate return -->
    <line class="gd-edge" x1="696" y1="428" x2="304" y2="428" stroke-dasharray="5,4" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="400" y="417" font-size="8" text-anchor="middle" letter-spacing="0.06em">ACC + PER-ACTION</text>

    <!-- m9 self: gates -->
    <path class="gd-edge" d="M304,456 L328,456 Q336,456 336,464 L336,472 Q336,480 328,480 L304,480" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="348" y="471" font-size="8" letter-spacing="0.06em">KEEP / REJECT GATES</text>

    <!-- m10 persist round -->
    <line class="gd-edge" x1="304" y1="512" x2="896" y2="512" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="800" y="501" font-size="8" text-anchor="middle" letter-spacing="0.06em">INSERT ROUND + FAILURES</text>

    <!-- m11 test eval -->
    <line class="gd-edge" x1="304" y1="580" x2="696" y2="580" :marker-end="`url(#${arrowId})`" />
    <text class="gd-label gd-label--knockout" x="600" y="569" font-size="8" text-anchor="middle" letter-spacing="0.06em">EVAL TEST · 400</text>
    <!-- m12 test_accuracy (headline) -->
    <line class="gd-edge gd-edge--focal" x1="696" y1="612" x2="304" y2="612" :marker-end="`url(#${arrowFocalId})`" />
    <text class="gd-label gd-label--focal gd-label--knockout" x="400" y="601" font-size="8" text-anchor="middle" letter-spacing="0.06em">TEST_ACCURACY</text>

    <!-- Actors -->
    <rect class="gd-node gd-node--ui" x="28" y="40" width="144" height="48" rx="6" />
    <text class="gd-title" x="100" y="60" font-size="12" font-weight="600" text-anchor="middle">Operator UI</text>
    ...
    <text class="gd-title" x="300" y="60" font-size="12" font-weight="600" text-anchor="middle">Optimizer task</text>
    ...
    <text class="gd-title" x="500" y="60" font-size="12" font-weight="600" text-anchor="middle">Optimizer LLM</text>
    ...
    <text class="gd-title" x="700" y="60" font-size="12" font-weight="600" text-anchor="middle">Evaluator</text>
    <text class="gd-meta" x="700" y="76" font-size="9" text-anchor="middle">EvalRun · Semaphore(10)</text>

    <rect class="gd-node gd-node--store" x="828" y="40" width="144" height="48" rx="6" />
    <text class="gd-title" x="900" y="60" font-size="12" font-weight="600" text-anchor="middle">PostgreSQL</text>
    <text class="gd-meta" x="900" y="76" font-size="9" text-anchor="middle">runs · rounds · failures</text>
    ...
    <line class="gd-edge" x1="220" y1="724" x2="240" y2="724" stroke-dasharray="5,4" :marker-end="`url(#${arrowId})`" />
    <text class="gd-legend" x="248" y="728" font-size="9">Return</text>
    <line class="gd-edge gd-edge--http" x1="320" y1="724" x2="340" y2="724" :marker-end="`url(#${arrowHttpId})`" />
