...
<template>
  ...
  >
    ...
    <desc :id="descId">
      Flowchart of one optimizer run: snapshot the validation set and measure the baseline, loop
      rounds of candidate generation and gating until the target accuracy or max rounds is reached,
      score the best prompt on the held-out test snapshot, then hand off to the operator activation
      gate.
    </desc>
    <defs>
    ...
    <path
      class="gd-edge"
      d="M240,364 L88,364 Q80,364 80,356 L80,268 Q80,260 88,260 L280,260"
      :marker-end="`url(#${arrowId})`"
    />
    <text class="gd-label gd-label--knockout" x="92" y="313" font-size="8" letter-spacing="0.06em">
      NEXT ROUND
    </text>

    <!-- N1 start -->
    <rect class="gd-node" x="280" y="48" width="240" height="48" rx="20" />
    <text class="gd-title" x="400" y="68" font-size="12" font-weight="600" text-anchor="middle">
      Start optimizer run
    </text>
    <text class="gd-meta" x="400" y="84" font-size="9" text-anchor="middle">
      POST /optimizer/run · max_rounds · target
    </text>

    <!-- N2 snapshot + baseline -->
    <rect class="gd-node" x="280" y="136" width="240" height="56" rx="6" />
    <text class="gd-title" x="400" y="160" font-size="12" font-weight="600" text-anchor="middle">
      Snapshot val set + baseline eval
    </text>
    <text class="gd-meta" x="400" y="176" font-size="9" text-anchor="middle">
      200 fixed cases → baseline_accuracy
    </text>

    <!-- N3 round -->
    <rect class="gd-node" x="280" y="232" width="240" height="56" rx="6" />
    <text class="gd-title" x="400" y="256" font-size="12" font-weight="600" text-anchor="middle">
      Round N: candidate + gates
    </text>
    <text class="gd-meta" x="400" y="272" font-size="9" text-anchor="middle">
    ...
    <text class="gd-title" x="400" y="360" font-size="12" font-weight="600" text-anchor="middle">
      Target reached or max rounds?
    </text>
    <text class="gd-meta" x="400" y="376" font-size="8" text-anchor="middle">
      accuracy ≥ target · rounds ≥ max_rounds
    </text>

    <!-- N5 test acceptance -->
    <rect class="gd-node" x="280" y="440" width="240" height="56" rx="6" />
    <text class="gd-title" x="400" y="464" font-size="12" font-weight="600" text-anchor="middle">
      Test-set acceptance
    </text>
    <text class="gd-meta" x="400" y="480" font-size="9" text-anchor="middle">
      best prompt × 400 held-out → test_accuracy
    </text>

    <!-- N6 operator gate (focal) -->
    <rect class="gd-node gd-node--focal" x="280" y="536" width="240" height="48" rx="20" />
    <text class="gd-title" x="400" y="556" font-size="12" font-weight="600" text-anchor="middle">
      Operator activation gate
    </text>
    <text class="gd-meta" x="400" y="572" font-size="9" text-anchor="middle">
