...
Confusion Matrix（可選）
            預測→  rebuild  fallback  restart  notify  email
期望↓
trigger_rebuild      18        0         2       0      0
trigger_fallback      3       14         2       1      0
trigger_restart       5        1        11       3      0
notify_human          2        0         3      14      1
send_email            0        0         1       2     17
```
...
若某個 action < 20 筆，顯示警告：⚠️ 樣本不足，該類別準確率可能不準。
